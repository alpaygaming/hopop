...
const styles = StyleSheet.create({
  ...
  mainTitle: { fontSize: 32, fontWeight: '800', color: '#000', marginBottom: 24, letterSpacing: -1 },
  allMapCard: { backgroundColor: '#000', padding: 24, borderRadius: 16, alignItems: 'center', marginBottom: 24, shadowColor: '#000', shadowOffset: {width: 0, height: 8}, shadowOpacity: 0.15, shadowRadius: 12, elevation: 8 },
  allMapTitle: { color: '#ffffff', fontSize: 16, fontWeight: '700', letterSpacing: 1 },
  categoryGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' },
  categoryCard: { width: '48%', backgroundColor: '#ffffff', padding: 24, borderRadius: 16, alignItems: 'center', marginBottom: 16, borderWidth: 1, borderColor: '#eee', shadowColor: '#000', shadowOffset: {width: 0, height: 4}, shadowOpacity: 0.05, shadowRadius: 8, elevation: 2 },
  catName: { marginTop: 12, fontWeight: '600', fontSize: 14, color: '#333' },
